...
- Generated, imported, auto-captured, and sidecar-produced metadata starts as review-gated evidence, not instruction-grade memory.
- Streamable HTTP support and GitHub Actions CI are implemented, despite some stale future wording in the README/roadmap.
...
- Do not treat generated or imported memory as trusted instruction without review.
